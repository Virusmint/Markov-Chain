...
\subsection*{Accessibility and Communication}
	...
	\end{proposition}
	\begin{proof}
		We must prove that the relation is \emph{reflexive}, \emph{symmetric}, and \emph{transitive}. 
		We will focus our attention on \emph{transitivity} and leave the rest as exercises. \\
	...
	and $p_{kj}(m) > 0$), then the following inequality holds true only for the communicating intermediate states $s_k$.
